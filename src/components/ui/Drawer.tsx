...
const Drawer = ({ closeButton, children }: Props) => {
  return (
    <div
      id="drawer-form"
      className="fixed top-18 right-0 z-100 h-screen p-4 overflow-y-auto transition-transform duration-400 translate-x-full w-100 bg-accent border-t border-gray-600 shadow-lime-300"
      tabIndex={-1}
